    ...
    <div className="section-padding relative overflow-hidden" id="about">
      ...
      <div className="container-modern">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-10 lg:mb-4">
          {/* Left Side - Image */}
          <div className="flex w-full justify-center lg:justify-start relative order-2 lg:order-1">
          ...
          <div className="flex flex-col items-start justify-center w-full order-1 lg:order-2">
